...
export default function GoalsList({ goals, isLoading, onDelete, onUpdateGoal, editState }) {
	...
	return (
		<div style={goalsStyles.goalGrid}>
			{goals.map((goal) => (
				<GoalCard editState={editState} key={goal._id} goal={goal} onDelete={onDelete} onUpdateGoal={onUpdateGoal} />
			))}
		</div>
	);
}
